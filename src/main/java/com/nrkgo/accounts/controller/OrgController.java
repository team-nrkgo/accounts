...
public class OrgController {
    ...
    public ResponseEntity<ApiResponse<Void>> acceptInvite(
        ...
        // Note: For accept invite, user might already be logged in OR strictly just
        // claiming via token.
    ...
    public ResponseEntity<ApiResponse<com.nrkgo.accounts.dto.InvitationDetailsResponse>> getInvitationDetails(
        ...
        // Let's call a new method or overload getInvitationDetails to handle session
        // creation.
        ...
        // I need to fetch the User object associated with this token to create a
        // session.

        // Refactoring: service.validateInviteAndLogin(token, request) -> returns
        // Session + Details?
        // Let's keep it simple: calling a new method to get session, then returning
        // details.
    ...
    public ResponseEntity<ApiResponse<java.util.List<com.nrkgo.accounts.dto.OrgMemberResponse>>> getOrgMembers(
        ...
        java.util.List<com.nrkgo.accounts.dto.OrgMemberResponse> members = orgService.getOrgMembers(org_id,
                user.getId(), search);
    ...
    public ResponseEntity<ApiResponse<com.nrkgo.accounts.model.Role>> createRole(
        ...
        return ResponseEntity
                .ok(ApiResponse.success("Role created", orgService.createOrgRole(request, org_id, user.getId())));
    }
    ...
    public ResponseEntity<ApiResponse<com.nrkgo.accounts.model.Role>> updateRole(
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Role updated", orgService.updateOrgRole(roleId, request, org_id, user.getId())));
    }
